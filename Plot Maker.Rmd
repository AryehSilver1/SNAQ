...
ringBarB = ggplot(Bsummary, aes(x = ringNumber, y = Mean, fill = typeCat)) +
  ...
  coord_polar("y") +
  labs(title = paste0("Proportion of cell types within each ring for ", markerB, " cells"),
       x = "",
       y = "",
       fill = "Classification") +
  geom_text(aes(label = round(Mean, 2)), position = position_stack(vjust = 0.5), size = 2.5, color = "white") +
  theme_void() +
  theme(axis.text.x = element_blank(), axis.text.y = element_blank())
ringBarB
...
ringBarA = ggplot(Asummary, aes(x = ringNumber, y = Mean, fill = typeCat)) +
  ...
  scale_fill_manual(labels = c("A" = markerA, "B.C" = paste0(markerC, "+ ", markerB), "CnotB.C" = paste0(markerC, "- ", markerB), "D" = markerD),
                    values = c("A" = "brown1", "B.C" = "deepskyblue", "CnotB.C" = "deepskyblue3", "D" = "azure4")) +
  coord_polar("y") +
  labs(title = paste0("Proportion of cell types within each ring for ", markerA, " cells"),
       x = "",
       y = "",
       fill = "Classification") +
  geom_text(aes(label = round(Mean, 2)), position = position_stack(vjust = 0.5), size = 2.5, color = "white") +
...
ringBarD = ggplot(Dsummary, aes(x = ringNumber, y = Mean, fill = typeCat)) +
  ...
  scale_fill_manual(labels = c("A" = markerA, "B.C" = paste0(markerC, "+ ", markerB), "CnotB.C" = paste0(markerC, "- ", markerB), "D" = markerD),
                    values = c("A" = "brown1", "B.C" = "deepskyblue", "CnotB.C" = "deepskyblue3", "D" = "azure4")) +
  coord_polar("y") +
  labs(title = paste0("Proportion of cell types within each ring for ", markerD, " cells"),
       x = "",
       y = "",
       fill = "Classification") +
  geom_text(aes(label = round(Mean, 2)), position = position_stack(vjust = 0.5), size = 2.5, color = "white") +
...
ringBarC.B = ggplot(C.Bsummary, aes(x = ringNumber, y = Mean, fill = typeCat)) +
  ...
  scale_fill_manual(labels = c("A" = markerA, "B.C" = paste0(markerC, "+ ", markerB), "CnotB.C" = paste0(markerC, "- ", markerB), "D" = markerD),
                    values = c("A" = "brown1", "B.C" = "deepskyblue", "CnotB.C" = "deepskyblue3", "D" = "azure4")) +
  coord_polar("y") +
  labs(title = paste0("Proportion of cell types within each ring for ", markerC, "+ ", markerB, " cells"),
       x = "",
       y = "",
       fill = "Classification") +
  geom_text(aes(label = round(Mean, 2)), position = position_stack(vjust = 0.5), size = 2.5, color = "white") +
...
barC = ggplot(Cbargraph, aes(x = identity, y = percent, fill = Cplusorminus)) +
  ...
  labs(title = paste0("Percent of ", markerC, "+ and ", markerC, "- per cell type"),
       ...
       y = "Percent",
       fill = "Identity") +
  geom_text(aes(label = paste(round(percent, 2))), position = position_fill(reverse = FALSE), vjust = 2, color = "black") +
  scale_x_discrete(limits = c("A", "B", "D"), labels = c("B" = markerB, "A" = markerA, "D" = markerD))
barC
