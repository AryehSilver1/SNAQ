...
boxwhiskerB = ggplot(newCombo, aes(x = identityCat, y = Bprop, fill = identityCat)) +
  ...
  geom_text(data = medians, aes(label = round(Bprop, 2)), vjust = -0.2) +
  theme(legend.position = "none")
boxwhiskerB

graphTitle = paste0(graphOutputPath, "/", markerB, "_Neighbor_Comparison", ".png")
ggsave(graphTitle, boxwhiskerB, width = 6, height = 4, units = "in", dpi = 600)
...
boxwhiskerA = ggplot(newCombo, aes(x = identityCat, y = Aprop, fill = identityCat)) +
  ...
  geom_signif(comparisons = list(c("B", "A"), c("A", "D"), c("B", "D")),
              ...
              y_position = c(1, 1.08, 1.16)) +
  scale_x_discrete(labels = c("B" = markerB, "A" = markerA, "D" = markerD), limits = c("B", "A", "D")) +
  geom_text(data = medians, aes(label = round(Aprop, 2)), vjust = -0.2) +
  theme(legend.position = "none")
boxwhiskerA

graphTitle = paste0(graphOutputPath, "/", markerA, "_Neighbor_Comparison", ".png")
ggsave(graphTitle, boxwhiskerA, width = 6, height = 4, units = "in", dpi = 600)
...
boxwhiskerD = ggplot(newCombo, aes(x = identityCat, y = Dprop, fill = identityCat)) +
  ...
  geom_signif(comparisons = list(c("B", "A"), c("A", "D"), c("B", "D")),
              ...
              y_position = c(1, 1.08, 1.16)) +
  scale_x_discrete(labels = c("B" = markerB, "A" = markerA, "D" = markerD), limits = c("B", "A", "D")) +
  geom_text(data = medians, aes(label = round(Dprop, 2)), vjust = -0.2) +
  theme(legend.position = "none")
boxwhiskerD

graphTitle = paste0(graphOutputPath, "/", markerD, "_Neighbor_Comparison", ".png")
ggsave(graphTitle, boxwhiskerD, width = 6, height = 4, units = "in", dpi = 600)
...
boxwhiskerC = ggplot(newCombo, aes(x = identityCat, y = Cprop, fill = identityCat)) +
  ...
  geom_signif(comparisons = list(c("B", "A"), c("A", "D"), c("B", "D")),
              ...
              y_position = c(1, 1.08, 1.16)) +
  scale_x_discrete(labels = c("B" = markerB, "A" = markerA, "D" = markerD), limits = c("B", "A", "D")) +
  geom_text(data = medians, aes(label = round(Cprop, 2)), vjust = -0.2) +
  theme(legend.position = "none")
boxwhiskerC

graphTitle = paste0(graphOutputPath, "/", markerC, "_Neighbor_Comparison", ".png")
ggsave(graphTitle, boxwhiskerC, width = 6, height = 4, units = "in", dpi = 600)
...
boxwhiskerB.C = ggplot(newCombo, aes(x = identityCat, y = B.Cprop, fill = identityCat)) +
  ...
  geom_signif(comparisons = list(c("B", "A"), c("A", "D"), c("B", "D")),
              ...
              y_position = c(1, 1.08, 1.16)) +
  scale_x_discrete(labels = c("B" = markerB, "A" = markerA, "D" = markerD), limits = c("B", "A", "D")) +
  geom_text(data = medians, aes(label = round(B.Cprop, 2)), vjust = -0.2, color = "black") +
  theme(legend.position = "none")
boxwhiskerB.C

graphTitle = paste0(graphOutputPath, "/", markerC, "+", markerB, "_Neighbor_Comparison", ".png")
ggsave(graphTitle, boxwhiskerB.C, width = 6, height = 4, units = "in", dpi = 600)
...
num = 1  #this is the image number for these graphs
...
ringBarB = ggplot(Bsummary, aes(x = ringNumber, y = Mean, fill = typeCat)) +
  ...
  coord_polar("y") +
  labs(title = paste0(markerB, " cells only: Proprtion of neighbor cells in each ring"),
       x = "",
       y = "",
       fill = "Classification") +
...
graphTitle = paste0(graphOutputPath, "/", markerB, "_cells_only_Proprtion_of_neighbor_cells_in_each_ring", ".png")
...
ringBarA = ggplot(Asummary, aes(x = ringNumber, y = Mean, fill = typeCat)) +
  ...
  scale_fill_manual(labels = c("A" = markerA, "B" = markerB, "D" = markerD), values = c("brown1", "deepskyblue2", "azure4")) +
  coord_polar("y") +
  labs(title = paste0(markerA, " cells only: Proprtion of neighbor cells in each ring"),
       x = "",
       y = "",
       fill = "Classification") +
  geom_text(aes(label = round(Mean, 2)), position = position_stack(vjust = 0.5), size = 2, color = "white") +
...
graphTitle = paste0(graphOutputPath, "/", markerA, "_cells_only_Proprtion_of_neighbor_cells_in_each_ring", ".png")
...
ringBarD = ggplot(Dsummary, aes(x = ringNumber, y = Mean, fill = typeCat)) +
  ...
  scale_fill_manual(labels = c("A" = markerA, "B" = markerB, "D" = markerD), values = c("brown1", "deepskyblue2", "azure4")) +
  coord_polar("y") +
  labs(title = paste0(markerD, " cells only: Proprtion of neighbor cells in each ring"),
       x = "",
       y = "",
       fill = "Classification") +
  geom_text(aes(label = round(Mean, 2)), position = position_stack(vjust = 0.5), size = 2, color = "white") +
...
graphTitle = paste0(graphOutputPath, "/", markerD, "_cells_only_Proprtion_of_neighbor_cells_in_each_ring", ".png")
...
ringBarC.B = ggplot(C.Bsummary, aes(x = ringNumber, y = Mean, fill = typeCat)) +
  ...
  scale_fill_manual(labels = c("A" = markerA, "B" = markerB, "D" = markerD), values = c("brown1", "deepskyblue2", "azure4")) +
  coord_polar("y") +
  labs(title = paste0(markerC, "+ ", markerB, " cells only: Proprtion of neighbor cells in each ring"),
       x = "",
       y = "",
       fill = "Classification") +
  geom_text(aes(label = round(Mean, 2)), position = position_stack(vjust = 0.5), size = 2, color = "white") +
...
graphTitle = paste0(graphOutputPath, "/", markerC, "+", markerB, "_cells_only_Proprtion_of_neighbor_cells_in_each_ring", ".png")
...
graphTitle = paste0(graphOutputPath, "/", "Proportion_of ", markerC, "+_and_", markerC, "_-_for_each_cell_type", ".png")
ggsave(graphTitle, barC, width = 6, height = 4, units = "in", dpi = 600)
...
graphTitle = paste0(graphOutputPath, "/", "Number_of_", markerC, "+_and_", markerC, "_-_cells_for_each_cell_type", ".png")
...
plotClosest = ggplot(data = closestCombo, aes(x = category, y = dist, fill = category)) +
  ...
  geom_signif(comparisons = list(c("distToD", "distToA")),
              ...
              textsize = 4,
              y_position = 75) +
  scale_x_discrete(limits = c("distToA", "distToD"), labels = c("distToA" = paste0("distance to ", markerA), "distToD" = paste0("distance to ", markerD))) +
  labs(title = paste0("Average distance of the closest ", markerA, " or ", markerD, " from each ", markerB),
       x = "Cell Type",
       y = "Distance (µm)") +
...
plotClosestB.C = ggplot(data = closestCombo_B.C, aes(x = category, y = dist, fill = category)) +
  ...
  geom_signif(comparisons = list(c("distToA", "distToD")),
              ...
              y_position = 75) +
  scale_x_discrete(limits = c("distToA", "distToD"), labels = c("distToA" = paste0("distance to ", markerA), "distToD" = paste0("distance to ", markerD))) +
  labs(title = paste0("Average distance of the closest ", markerA, " or ", markerD, " from each ", markerC, "+ ", markerB),
       x = "Cell Type",
       y = "Distance (µm)") +
  geom_text(data = medians, aes(label = round(dist, 2)), vjust = -0.5) +
  theme(legend.position = "none")
...
plotClosestCell = ggplot(data = closestCell, aes(x = category, y = dist, fill = category)) +
  ...
  scale_x_discrete(limits = c("distToCell"), labels = c("distToCell" = "distance to Cell")) +
  labs(title = paste0("Control: Average distance of the closest cell from each ", markerB),
       x = "Cell Type",
       y = "Distance (µm)") +
...
plotClosestB = ggplot(data = closestB, aes(x = category, y = dist, fill = category)) +
  ...
  labs(title = paste0("Opposite: Average distance of the closest ", markerB, " from each ", markerA,  " or ",  markerD),
       x = "Cell Type",
       y = "Distance (µm)") +
  geom_text(data = medians, aes(label = round(dist, 2)), vjust = -0.5) +
  theme(legend.position = "none")
...
plotClosest10B = ggplot(data = closest10B, aes(x = category, y = dist, fill = category)) +
  ...
  labs(title = paste0("Opposite: Average distance of the closest 10 ", markerB, " from each ", markerA, " or ", markerD),
       x = "Cell Type",
       y = "Distance (µm)") +
  geom_text(data = medians, aes(label = round(dist, 2)), vjust = -0.5) +
  theme(legend.position = "none")
...
plotClosestB.C = ggplot(data = closestB.C, aes(x = category, y = dist, fill = category)) +
  ...
  scale_x_discrete(limits = c("AdistToB.C", "DdistToB.C"), labels = c("AdistToB.C" = paste0("distance from ", markerA, " to ", markerC, "+ ", markerB), "DdistToB.C" = paste0("distance from ", markerD, " to ", markerC, "+ ", markerB))) +
    labs(title = paste0("Opposite: Average distance of the closest ", markerC, "+ ", markerB, " from each ", markerA, " or ", markerD),
       x = "Cell Type",
       y = "Distance (µm)") +
  geom_text(data = medians, aes(label = round(dist, 2)), vjust = -0.5) +
  theme(legend.position = "none")
...
plotCTRClosestCell = ggplot(data = CTRclosestCell, aes(x = category, y = dist, fill = category)) +
  ...
  labs(title = paste0("Control for Opposite: Average distance of the closest cell from each ", markerA, " or ", markerD),
       x = "Cell Type",
       y = "Distance (µm)") +
